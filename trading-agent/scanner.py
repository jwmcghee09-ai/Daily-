...
STATE_FILE   = BASE / "scanner_state.json"
LOG_FILE     = BASE / "scanner.log"
TRIGGER_FILE = BASE / "scanner_trigger.json"
...
def invoke_agent(anomalies: list, priority: list):
    ...
    subprocess.Popen([sys.executable, str(BASE / "agent.py")], **kwargs)
